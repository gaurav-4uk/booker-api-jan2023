...
public class CreateBookingTest19 {
	String respToken;
	int bookingID;
...
//		System.out.println("response .prettyPrint(): "+res.prettyPrint());
	...
	//-----------------------CREATING BOOKING (BODY AS A STRING)--------------
	@Test (enabled = false)
	...
	//----------------------CREATING BOOKING (WITH POJO CLASSES)------------
	@Test
	...
	//-------------PRIVATE METHOD USED BY MORE THAN ONE TEST FOR VALIDATING RESPONSE--------------
	...
	//-------------------GET BOOKING BY ID USING DESERIALIZATION--------------
	...
	//--------------PARCH - PARTIAL UPDATING BOOKING------------------
	@Test (priority = 4)
	...
	//---------------DELETE - DELETING THE BOOKING BY ID--------------------
	@Test (priority = 5)
