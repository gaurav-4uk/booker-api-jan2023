package testcripts;
//GetBooking
//creating private method which is called multiple times.
//Deserialisation converting json to java object and comparing both POJOs.
//comparing both pojo java objects using .equals method overriding of the Object class.
...
public class CreateBookingTest15 {
	String respToken;
	int bookingID;
